package com.troytan.sixpack.aspect;
...
public class ServiceAspect {
    ...
    private static final Logger logger = LoggerFactory.getLogger("com.troytan.sixpack.errorLog");

    @AfterThrowing(pointcut = "execution(public * com.troytan.sixpack..*.*(..)) && @within(org.springframework.stereotype.Service)", throwing = "e")
